        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600 dark:text-slate-300">
              Nyle Digital turns business ideas into fast, memorable web apps, mobile products, cloud platforms, and internal tools. The result feels premium on the surface and dependable underneath.
            </p>
