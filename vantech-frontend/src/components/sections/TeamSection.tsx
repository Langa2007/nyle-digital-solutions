    ...
    <section className="py-20 bg-white dark:bg-stone-950">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-stone-300 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white dark:bg-stone-900 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <p className="text-blue-600 dark:text-amber-300 font-medium mb-4">
                    {member.role}
                  </p>
                  ...
                  <div className="flex items-center space-x-3">
                    <a
                      ...
                      className="p-2 bg-gray-100 dark:bg-stone-700 text-gray-700 dark:text-stone-300 hover:bg-blue-100 dark:hover:bg-amber-900 hover:text-blue-600 dark:hover:text-amber-300 rounded-lg transition-colors"
                      aria-label="LinkedIn"
                    >
