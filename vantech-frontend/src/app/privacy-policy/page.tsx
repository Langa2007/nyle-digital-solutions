...
export const metadata: Metadata = {
  title: 'Privacy Policy | Vantech Software Solutions',
  description: 'Privacy Policy for Vantech Software Solutions. Learn how we handle and protect your data.',
  alternates: {
    ...
    <div className="pt-32 pb-24 min-h-screen section-atmosphere">
      <div className="section-shell relative z-10 max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-700 dark:text-slate-300">
          ...
          <p>
            Vantech Software Solutions ("we," "our," or "us") respects your privacy and is committed to protecting your personal data. 
